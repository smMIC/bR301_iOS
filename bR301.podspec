Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   This is mostly a podified fork of Feitians [sdk](https://github.com/FeitianSmartcardReader/bR301_iOS) with the important addition of being able
                   to run (albeit without proper functionality) in the iOS Simulator.
                   DESC
  ...
  s.source       = { :git => "/Users/marcotresch/Projects/MIC/feitian/bR301_iOS", :branch => "podification" }
